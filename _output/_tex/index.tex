...
\begin{tcolorbox}[enhanced jigsaw, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{On the simplified nature of analysis in this document.}, left=2mm, toptitle=1mm, arc=.35mm, opacityback=0, rightrule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, bottomtitle=1mm, colback=white, titlerule=0mm, bottomrule=.15mm, leftrule=.75mm, breakable, opacitybacktitle=0.6, coltitle=black, colframe=quarto-callout-warning-color-frame]
