...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colback=white, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{On the simplified nature of analysis in this document.}, left=2mm, arc=.35mm, colframe=quarto-callout-warning-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-warning-color!10!white, toprule=.15mm, bottomtitle=1mm, rightrule=.15mm, breakable, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, coltitle=black]
...
\begin{tcolorbox}[enhanced jigsaw, opacityback=0, colback=white, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, left=2mm, arc=.35mm, colframe=quarto-callout-note-color-frame, opacitybacktitle=0.6, leftrule=.75mm, colbacktitle=quarto-callout-note-color!10!white, toprule=.15mm, bottomtitle=1mm, rightrule=.15mm, breakable, toptitle=1mm, titlerule=0mm, bottomrule=.15mm, coltitle=black]
...
\textsubscript{Source:
\href{https://ds-an.github.io/computational-finance-project/index-preview.html}{Article
Notebook}}
