...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-warning-color-frame, rightrule=.15mm, titlerule=0mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{On the simplified nature of analysis in this document.}, toprule=.15mm, colbacktitle=quarto-callout-warning-color!10!white, colback=white, bottomtitle=1mm, arc=.35mm, left=2mm, toptitle=1mm, leftrule=.75mm, breakable, opacitybacktitle=0.6, coltitle=black]
...
analysis iming to showcase our understanding of course material and
...
\begin{tcolorbox}[enhanced jigsaw, colframe=quarto-callout-note-color-frame, rightrule=.15mm, titlerule=0mm, opacityback=0, bottomrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, toprule=.15mm, colbacktitle=quarto-callout-note-color!10!white, colback=white, bottomtitle=1mm, arc=.35mm, left=2mm, toptitle=1mm, leftrule=.75mm, breakable, opacitybacktitle=0.6, coltitle=black]
